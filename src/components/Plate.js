...
const Plate = ({id, readOnly }) => {

    return (
      <div className = { `valleForm__plate-container ${!readOnly ? 'valleForm__plate-container--readOnly' : null}`}>
        ...
        <div className = {`valleForm__plate`}>

          <div className = "valleForm__plate__header">

            <div className = "valleForm__plate__header__mercosul">

              <svg svg="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/2000/svg" version="1.0" height="45" width="100" viewBox="0 0 417.46362 146.762" id="svg2" space="preserve">
                <g id="g3062">
                  <rect id="_132032680-0" style={{fill:'none',stroke:'none',strokeWidth:1}} y="0" x="0" height="40" width="40"/>
                  <path id="_132032584-0" style={{fill:'none', stroke:'#00875d', strokeWidth:2.00200009}} d="M 222.06826,106.67046 C 282.58648,84.023133 343.10489,78.513709 403.62371,85.916226"/>
                  <polygon id="_132032416-2" style={{fill:'#ffffff'}} points="111.233,31.0675 116.541,29.2244 118.386,23.9164 120.227,29.2244 125.535,31.0678 120.227,32.9105 118.384,38.2185 116.538,32.9105 111.233,31.0675 " transform="matrix(1.0026977,0,0,1.0026977,208.41071,0.2651907)"/>
                  <polygon id="_132031840-0" style={{fill:'#ffffff'}} points="90.0706,19.0952 95.3786,17.2522 97.224,11.9442 99.0647,17.2522 104.373,19.0956 99.0646,20.9383 97.2215,26.2462 95.3764,20.9383 90.0706,19.0952 " transform="matrix(1.0026977,0,0,1.0026977,208.41071,0.2651907)"/>
                  <polygon id="_132031768-1" style={{fill:'#ffffff'}} points="72.9627,38.2188 78.2707,36.3758 80.1161,31.0678 81.9568,36.3758 87.2647,38.2192 81.9567,40.0619 80.1136,45.3698 78.2684,40.0619 72.9627,38.2188 " transform="matrix(1.0026977,0,0,1.0026977,208.41071,0.2651907)"/>
                  <polygon id="_9365136-9" style={{fill: '#ffffff'}} points="97.2816,72.4705 102.612,70.6274 104.521,65.3195 106.298,70.6274 111.584,72.4708 106.253,74.3135 104.346,79.6215 102.565,74.3135 97.2816,72.4705 " transform="matrix(1.0026977,0,0,1.0026977,208.41071,0.2651907)"/>
                  ...
                  <polygon id="_142877768-3" style={{fill:'#ffffff'}} points="60.2052,112.111 60.2052,114.893 52.0983,114.893 52.0983,121.545 59.9341,121.545 59.9341,124.338 52.0983,124.338 52.0983,131.118 60.467,131.118 60.467,133.894 49.3587,133.894 49.3587,112.111 49.3587,112.111 " transform="matrix(1.0026977,0,0,1.0026977,208.41071,0.2651907)"/>
                  <path id="path2850" style={{fill: '#ffffff', fillOpacity:1, stroke: 'none'}} d="m 382.58563,112.64593 0,21.87402 11.23528,0 0,-2.74823 -8.48699,0 0,-19.12579 -2.74829,0 z" />
                </g>
              </svg>

            </div>

            <div className = "valleForm__plate__header__country-name">
              BRASIL
            </div>

            <div className = "valleForm__plate__header__flag">

              <svg xmlns="http://www.w3.org/2000/svg" xmlns="http://www.w3.org/1999/xlink" height="31" width="44" version="1.1" viewBox="-2100 -1470 4200 2940">
                <defs>
          ...
          <div className = "valleForm__plate__number">
          </div>


          <div className = "valleForm__plate__country">
            BR
          </div>
