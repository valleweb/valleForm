  ...
  if(button.action == 'save') {
    return (
      <valle-speed-dial-action
        ...
        onClick = { () => apiCreate(baseApi, canonicalApi, params, feedbackCb) }>
  ...
  if(button.action == 'update') {
    return (
      <valle-speed-dial-action
        ...
        label = { button.text }
        label-direction = "left"
        onClick = { () => apiUpdate(baseApi, canonicalApi, params, _id, feedbackCb, formCb) }>
  ...
  if(button.action == 'delete') {
    return (
      <valle-speed-dial-action
        ...
        label = { button.text }
        label-direction = "left"
        onClick = { () =>  apiDelete(baseApi, canonicalApi, params, _id, feedbackCb, formCb) }>
